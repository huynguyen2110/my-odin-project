    ...
    intelligenceFired() {
        if (this.recentHit.length === 0) {
            ...
            if (this.recentHit.length === 1) {
                arrayFire =
                    [
                        {x: this.recentHit[0].x - 1, y: this.recentHit[0].y}, {
                        x: this.recentHit[0].x,
                        y: this.recentHit[0].y - 1
                    },
                        {x: this.recentHit[0].x, y: this.recentHit[0].y + 1}, {
                        x: this.recentHit[0].x + 1,
                        y: this.recentHit[0].y
                    },
                    ]
            } else {
